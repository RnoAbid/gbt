...
const heartBlust = () => {
    text.innerHTML = "😒 You're really bad you have broken my heart 💔 😭😭";
...
const heartArrange = () => {
  text.innerHTML = "😤😤huhhh wait for a second";
  heartItem.forEach((item) => {
  ...
  setTimeout(() => {
    text.innerHTML =
      "Hehehe 😂😂 You can't break my heart 💞 I'm strong enough, try again another time😜";
  }, 5000);
};
